...
namespace netdexQL.Migrations
{
    ...
    [Migration("20240709015220_fix_relations_for_filtering")]
    partial class fix_relations_for_filtering
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetDexQL.Data.Models.MonType", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mon_types");

                    b.HasIndex("Name")
                        .HasDatabaseName("ix_mon_types_name");

                    b.ToTable("mon_types", (string)null);
                });
            ...
            modelBuilder.Entity("NetDexQL.Data.Models.PokemonOnType", b =>
                {
                    ...
                    b.HasKey("PokemonId", "MonTypeId")
                        .HasName("pk_pokemon_on_types");

                    b.HasIndex("MonTypeId")
                        .HasDatabaseName("ix_pokemon_on_types_mon_type_id");
            ...
            modelBuilder.Entity("NetDexQL.Data.Models.PokemonOnType", b =>
                {
                    b.HasOne("NetDexQL.Data.Models.MonType", "MonType")
                        .WithMany("PokemonTypes")
                        .HasForeignKey("MonTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pokemon_on_types_mon_types_mon_type_id");

                    b.HasOne("NetDexQL.Data.Models.Pokemon", "Pokemon")
                        .WithMany("PokemonTypes")
            ...
            modelBuilder.Entity("NetDexQL.Data.Models.TypeEffectiveness", b =>
                {
                    b.HasOne("NetDexQL.Data.Models.MonType", "AttackingType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_type_effectivenesses_mon_types_attacking_type_id");
                    ...
                    b.HasOne("NetDexQL.Data.Models.MonType", "DefendingType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_type_effectivenesses_mon_types_defending_type_id");
